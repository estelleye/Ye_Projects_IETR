...
HD_PWD='D:/vivado_2017.1/DPR/PR_add_sub_int/PR_add_sub_int.runs/design_1_dma_in1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_dma_in1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_dma_in1_1.tcl
