...
#define OS_ARG_CHK_EN             0u//1u   /* Enable (1) or Disable (0) argument checking                  */
...
#define OS_TASK_STAT_EN           0u//1u   /*     Enable (1) or Disable(0) the statistics task             */
...
#define OS_TASK_SW_HOOK_EN        1u   /*     Include code for OSTaskSwHook()                          */
                                       ...
                                       /* ----------------------- EVENT FLAGS ------------------------ */
#define OS_FLAG_EN                0u//1u   /* Enable (1) or Disable (0) code generation for EVENT FLAGS    */
