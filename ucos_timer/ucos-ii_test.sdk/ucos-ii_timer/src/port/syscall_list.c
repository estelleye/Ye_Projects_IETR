 ...
 *  								0 (register	)61		frequency			void		void
 *	                                             62
 *
...
void sys_remap(unsigned long phy_addr)
{
	return syscall(9, phy_addr, 0, 0);
}


void sys_insert_mapping(unsigned long phys, unsigned long virt, unsigned int size)
{
...
/*
void sys_suspend(unsigned long rtn){
	syscall (18, rtn, 0, 0);
}
*/
