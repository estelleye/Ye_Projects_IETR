...
extern void sys_remap(unsigned long);
extern void sys_insert_mapping(unsigned long, unsigned long, unsigned int);


extern void sys_print(const char *ptr);

//extern void sys_suspend(unsigned long);
//extern void sys_print();
