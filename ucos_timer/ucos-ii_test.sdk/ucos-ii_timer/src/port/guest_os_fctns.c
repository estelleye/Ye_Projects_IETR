...
{
	//sys_vtimer_ctrl(61, freq, 0);//user boot_guest_os(guest_os_elf_02, 1, 1);
	//sys_vtimer_ctrl(62, freq, 0);//user boot_guest_os(guest_os_elf_03, 1, 2);
	//sys_vtimer_ctrl(63, freq, 0);//user boot_guest_os(guest_os_elf_04, 1, 3);
	//sys_vtimer_ctrl(64, freq, 0);// RTOS user boot_guest_os(guest_os_elf_01, 2, 0);
...
void guest_print(const char *ptr){ sys_print(ptr); }
//void guest_print(){ sys_print(); }


extern int int_flag;
void guest_idle(){

	guest_print(" RTOS IDLE ");
