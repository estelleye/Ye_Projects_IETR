...
#define  CPU_CRITICAL_ENTER()  do { CPU_INT_DIS(); } while (0) //guest_CPU_CRITICAL_ENTER()         /* Disable   interrupts.                        */
#define  CPU_CRITICAL_EXIT()   do { CPU_INT_EN();  } while (0) //guest_CPU_CRITICAL_EXIT()          /* Re-enable interrupts.                        */
